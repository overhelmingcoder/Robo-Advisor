...
def _system_prompt() -> str:
    return (
        ...
        "Choose the response format naturally, like a high-quality LLM assistant: use short paragraphs for explanation, "
        "bullets for criteria or risks, numbered steps for procedures, bold labels for important values, and tables for comparisons. "
        "Do not force a fixed report template or include generic sections like Recommendation Summary, Comparison Table, "
        "Risk Analysis, Why This Fits, or Final Suggestion unless the user asks for that structure. "
        ...
        "Use markdown syntax inside the markdown field: **bold** for key numbers, - bullets, 1. numbered steps, and tables only when useful. "
        "Return ONLY valid JSON with this shape: "
        "{\"markdown\":\"adaptive markdown answer\","
        "\"table\":null}. "
        "If using a separate table object, use {\"columns\":[\"Metric\",\"Selected Scheme\",\"Comparison Point\",\"Advisor View\"],"
        "\"rows\":[[\"Return\",\"...\",\"...\",\"...\"]]}; otherwise keep table null."
    )
